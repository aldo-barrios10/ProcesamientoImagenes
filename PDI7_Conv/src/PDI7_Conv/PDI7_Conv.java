...
public class PDI7_Conv extends javax.swing.JFrame implements MouseMotionListener{
        ...
        menu_borde.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(PDI7_Conv.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
