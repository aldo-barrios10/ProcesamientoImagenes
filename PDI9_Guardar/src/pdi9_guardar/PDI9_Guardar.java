...
public class PDI9_Guardar extends javax.swing.JFrame implements MouseMotionListener{
        ...
        menu_borde.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(PDI9_Guardar.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new PDI9_Guardar().setVisible(true);
            }
        });
    }
